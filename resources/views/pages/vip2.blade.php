...
<div class="row">
    ...
    <h1 class="p-color">Phòng VIP 2</h1>
...
<p>Khách sạn SUN HOTEL HẢI DƯƠNG có 3 loại phòng: VIP 1, VIP 2 và Phòng đôi.<br> Các dịch vụ tại khách sạn:<br> – Dịch vụ xe đưa đón.<br> – Dịch vụ đặt vé máy bay.<br> – Dịch vụ đổi ngoại tệ.<br> – Dịch vụ giặt là.<br> – Nhân viên phiên dịch tiếng Anh, Hàn, Trung.<br> – Phục vụ đồ ăn nhanh 24/24: Phở, mỳ tôm, cháo….   </p>
     </div>

    <div class="col medium-3">
        <p class="tu">Từ<br><span class="price">400.000đ</span>/ Đêm</p>
        <form action="{{URL::to('/dat-phong')}}" method="post">
            <input name="room_type" type="hidden" value="Phòng VIP 2">
